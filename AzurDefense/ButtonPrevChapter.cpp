...
ButtonPrevChapter::ButtonPrevChapter() {
	name = "ButtonPrevChapter";
	size = vec2(1.0f, 1.0f);
	clickable = true;
}

void ButtonPrevChapter::render() {
	renderLowerChild();
	Texture2D* texture = Game::getInstance()->getResourceManager()->getTexture("UI/ButtonPrevChapter");
...
int ButtonPrevChapter::click(GLFWwindow* window, int button, int action, int mods) {
